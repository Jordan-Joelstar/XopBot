...
let bots = false
const { bot_, react, bot } = require('../lib')
let utd = false
//---------------------------------------------------------------------------
...
bot(
 ...
 async (message, text) => {
  try {
   ...
   let action =
    textt.startsWith('on') || textt.startsWith('act') || textt.startsWith('enable') || textt.startsWith('true') ? 'true' : textt.startsWith('cmd') || textt.startsWith('command') ? 'cmd' : textt.startsWith('all') ? 'all' : textt.startsWith('off') || textt.startsWith('reset') || textt.startsWith('deact') || textt.startsWith('disable') ? 'false' : ''
   utd = true
   if (!action) {
