...
const { fancytext, smdBuffer, getBuffer, listall, prefix, smd, TelegraPh, Config } = require('../lib')
async function generateSticker(
 ...
 try {
  const { Sticker: _0x92981e, createSticker: _0x1a1a97, StickerTypes: _0x5f17c1 } = require('wa-sticker-formatter')
  let _0x54c67c = new _0x92981e(_0x5c979b, {
   ..._0x116cae,
  })
  return await _0x43a996.bot.sendMessage(
   _0x43a996.chat,
   {
...
smd(
 ...
 async (_0x3878b3, _0x4974a3) => {
  try {
   ...
   let { data: _0x3d14f3 } = await axios.get('https://api.telegra.ph/createPage?access_token=d3b25feccb89e508a9114afb82aa421fe2a9712b963b387cc5ad71e58722&title=Suhail-Md+Bot&author_name=Astro_Tech_Info&content=[%7B"tag":"p","children":["' + _0x531993.replace(/ /g, '+') + '"]%7D]&return_content=true')
