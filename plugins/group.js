...
const { sck, smd, send, Config, tlang, sleep, getAdmin, prefix } = require("../lib");
...
cmd(
 ...
 async (_0x3a5b8e, _0x227613) => {
  try {
   ...
   var _0x1bab1d = _0x4f45c0.participants.filter(({ id: _0x2f922b }) => _0x1a80c3.participants.some(({ id: _0x39bca2 }) => _0x39bca2 === _0x2f922b)) || [];
...
cmd(
 ...
 async (_0x210433, _0x375183) => {
  try {
   ...
   var _0x223a29 = _0x236ddc.participants.filter(({ id: _0x378856 }) => !_0x18f508.participants.some(({ id: _0x46f0d1 }) => _0x46f0d1 === _0x378856)) || [];
 ...
 async (_0xadbad4) => {
  try {
   ...
   await _0xadbad4.bot
    ...
    .then((_0x150a20) => _0xadbad4.reply("*_Group Chat Muted successfully!!_*"))
    .catch((_0x5d5c82) => _0xadbad4.reply("*_Can't change Group Setting, Sorry!_*"));
  } catch (_0x2bea0d) {
 ...
 async (_0x5d1afd) => {
  try {
   ...
   await _0x5d1afd.bot
    ...
    .then((_0x5993c4) => _0x5d1afd.reply("*_Group Chat UnMute successfully!!_*"))
    .catch((_0x293794) => _0x5d1afd.reply("*_Can't change Group Setting, Sorry!_*"));
  } catch (_0x3ea023) {
 ...
 async (_0x1dca9f, _0x44b327) => {
  try {
   ...
   await _0x1dca9f.bot
    ...
    .then((_0x49c387) => _0x1dca9f.reply("*_Group locked, Only Admin can change group settinggs!!_*"))
    .catch((_0x100d44) => _0x1dca9f.reply("*_Can't change Group Setting, Sorry!_*"));
  } catch (_0x9e6207) {
 ...
 async (_0xe880ee, _0x2dce84) => {
  try {
   ...
   await _0xe880ee.bot
    ...
    .then((_0x282118) => _0xe880ee.reply("*_Group unlocked, everyone change group settings!!_*"))
    .catch((_0x320353) => _0xe880ee.reply("*_Can't change Group Setting, Sorry!_*"));
  } catch (_0x20d64c) {
