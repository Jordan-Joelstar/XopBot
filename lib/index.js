...
const acrcloud = require("./class/init");
const { unixTimestampSecond, generateMessageTag, processTime, getBuffer, smdBuffer, fetchJson, astroJson, runtime, clockString, sleep, isUrl, getTime, formatDate, formatp, jsonformat, logic, generateProfilePicture, bytesToSize, getSizeMedia, parseMention, GIFBufferToVideoBuffer, smsg, callsg } = require("./serialized");
const {
 listall,
 strikeThrough,
 wingdings,
...
const { bot, Index, smd, commands, cmd } = require("./plugins");
const { sck1 } = require("./database/user");
const { sck } = require("./database/group");
const { alive } = require("./database/alive");
const { pg, dbs, groupdb, userdb, alivedb, bot_ } = require("./schemes");
const { sendAnimeReaction, yt, sendGImages, AudioToBlackVideo, textToLogoGenerator, photoEditor, updateProfilePicture, randomeFunfacts, getRandom, generateSticker, forwardMessage, plugins, audioEditor, send, react, note, sendWelcome, aitts } = require("./Asta");
...
module.exports = {
 ...
 shazam: async function shazam(_0x859a32) {
  ...
  let { title: _0x341b8a, artists: _0x4ac72a, album: _0x4a0f93, genres: _0x27dc36, release_date: _0x190efe, external_metadata: _0x43a980 } = _0xf13a35.metadata.music[0];
