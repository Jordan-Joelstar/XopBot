...
「 *${tiny(category)}* 」\n`
  ...
  if (/1|buttons|btn/gi.test(BUTTONS) && message.device !== 'web') {
   await sendButtons(message, {
    caption: menuText,
    buttons: `
 #button:cta_copy | display_text : Server| id:${prefix}cpu /# 
 #button:cta_copy | display_text : Script | id:${prefix}repo /#            
 #button:cta_copy | display_text : About | id:${prefix}list /#  
 #button:cta_text | display_text : Click Me | id: btn /#          
        `,
   })
  } else {
