...
if (fs.existsSync("./lib/lang/" + Config.LANG + ".json")) {
  var json = JSON.parse(fs.readFileSync("./lib/lang/" + Config.LANG + ".json"));
} else {
  var json = JSON.parse(fs.readFileSync("./lib/lang/asta.json"));
}
