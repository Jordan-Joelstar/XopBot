...
global.DATABASE_URL = global.DATABASE_URL || global.DATABASE_URI;
let cacheTable = {};
...
pg.new = async (_0x3e9dab, _0x45bd06) => {
 ...
 try {
  ...
  const _0x50f40d =
   ...
   _0x3e9dab +
   " (" +
   Object.keys(_0x45bd06).join(", ") +
   ")\n      VALUES (" +
   Object.keys(_0x45bd06)
    .map((_0x1cf7c5, _0x5a5bc8) => "$" + (_0x5a5bc8 + 1))
    .join(", ")
    .trim() +
 ...
 try {
  ...
  if (_0x3fb400.rows[0]) {
   const _0x5bcd95 =
    ...
    _0x3cb355 +
    " SET " +
    Object.keys(_0x479724)
     .map((_0x4bb12e, _0x1be704) => _0x4bb12e + " = $" + (_0x1be704 + 2))
     .join(", ") +
