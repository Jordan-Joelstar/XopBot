...
const { default: maWaSocket, proto, prepareWAMessageMedia, downloadContentFromMessage, DisconnectReason, useMultiFileAuthState, generateForwardMessageContent, generateWAMessageFromContent, makeInMemoryStore, jidDecode } = require("@whiskeysockets/baileys");
var last_status = {};
global.setCmdAlias = {};
...
const { sleep, getBuffer, parsedJid, tiny, botpic, tlang } = require("./index.js");
...
async function syncdb() {
 ...
 sock.ev.on("call", async (_0x522b10) => {
  let _0x37f540 = await callsg(sock, JSON.parse(JSON.stringify(_0x522b10[0])));
 ...
 sock.ev.on("messages.upsert", async (_0x1071af) => {
  try {
   _0x5b55c3 = _0x5b55c3 || sock.decodeJid(sock.user.id);
   if (!global.isStart) {
    return;
   ...
   for (mek of _0x1071af.messages) {
    ...
    let _0x5979da = await smsg(sock, JSON.parse(JSON.stringify(mek)), store, true);
 ...
 sock.ev.on("group-participants.update", async (_0x33a505) => {
  try {
   let _0x1684d7 = await groupsg(sock, JSON.parse(JSON.stringify(_0x33a505)), true);
   ...
   events.commands.map(async (_0x497293) => {
    ...
    if (/on|true|all/gi.test(_0x497293.group)) {
     try {
      _0x497293.function(_0x1684d7, {
       store: store,
       Void: sock,
 ...
 sock.ev.on("groups.update", async (_0x334a9c) => {
  try {
 ...
 sock.ev.on("groups.upsert", async (_0x6ac529) => {
  try {
   ...
   await groupsg(sock, JSON.parse(JSON.stringify(_0x6ac529[0])), false, true);
  } catch (_0x2ec500) {
   console.log(_0x2ec500);
  }
 });
 sock.ev.on("contacts.upsert", (_0x30754f) => {
  try {
 ...
 sock.ev.on("contacts.update", async (_0x557445) => {
  for (let _0x2d3aad of _0x557445) {
   let _0x42cd7b = sock.decodeJid(_0x2d3aad.id);
 ...
 sock.serializeM = (_0x40f3f1) => smsg(sock, _0x40f3f1, store, false);
 sock.ev.on("connection.update", async (_0x3fd0b3) => {
  const { connection: _0x2224a7, lastDisconnect: _0x309893 } = _0x3fd0b3;
  if (_0x2224a7 === "connecting") {
   log("Connecting ℹ️");
  }
  if (_0x2224a7 === "open") {
   let _0x89b8f6 = sock.decodeJid(sock.user.id);
...
`;
 ...
 sock.ev.on("creds.update", _0xd884d9);
 ...
 sock.sendContact = async (_0xee3400, _0x1ba9aa, _0x460513 = "", _0x345014 = {}) => {
  let _0x3b10d0 = [];
 ...
 sock.messageId = (_0x344ea2 = 8, _0x4bb246 = "SUHAILMD") => {
 ...
 sock.send5ButImg = async (_0x5014fe, _0x151c1b = "", _0x11eaa9 = "", _0x17f875, _0x1dc3ec = [], _0x148c68, _0x1b833a = {}) => {
 ...
 sock.sendButtonText = (_0x32e16b, _0x2e98df = [], _0x268834, _0x5dadfc, _0x3d9e07 = "", _0x40db80 = {}) => {
  let _0x2d84f4 = {
   text: _0x268834,
   footer: _0x5dadfc,
   buttons: _0x2e98df,
 ...
 sock.sendImage = async (_0x566754, _0x4723fa, _0x2087ca = "", _0x53d3a0 = "", _0x459604) => {
 ...
 sock.sendTextWithMentions = async (_0x54ea1e, _0x50c9ec, _0x2d2be2, _0x3a2080 = {}) =>
  sock.sendMessage(
   _0x54ea1e,
   {
    text: _0x50c9ec,
 ...
 sock.sendImageAsSticker = async (_0x3532c5, _0x527062, _0x3309ab = {}) => {
  let _0x262184;
 ...
 sock.sendVideoAsSticker = async (_0x10f5a6, _0x5c502f, _0x587709 = {}) => {
  let _0x4c63fd;
 ...
 sock.sendMedia = async (_0x2c82eb, _0x3b6f24, _0x1faf03 = "", _0x265eee = "", _0x43689c = "", _0x5f0c19 = {}) => {
 ...
 sock.downloadAndSaveMediaMessage = async (_0x23227c, _0x37efaf = "null", _0x3e6b5f = false, _0x2c905e = true) => {
 ...
 sock.forward = async (_0x5d4b74, _0x57d8d8, _0x15b451, _0x16bd40, _0x25719f = true) => {
  try {
 ...
 sock.forwardOrBroadCast2 = async (_0x2565bd, _0x442828, _0x145dd4 = {}, _0x23baf9 = "") => {
  try {
 ...
 sock.forwardOrBroadCast = async (_0x189e5c, _0x54c0d9, _0x18e0cf = {}, _0x348d78 = "") => {
  try {
 ...
 sock.copyNForward = async (_0x333b21, _0x4d04c0, _0x3c23fa = false, _0x4ed2c0 = {}) => {
  try {
   let _0x92cb9d;
 ...
 const _0x29f5c5 = {};
 let _0x51034c = [];
 sock.sendUi = async (_0x264148, _0x4d42ab = {}, _0x541cb3 = "", _0x2e5e1f = "", _0x3bceba = "", _0x171bcf = false) => {
  let _0x28cdb7 = {};
  try {
   ...
   let _0x237b02;
   if ((((_0x171bcf && _0x3bceba && Config.MSG_STYLE > 0) || !_0x3bceba) && /text|txt|nothing|smd|asta/.test(global.userImages)) || _0x2e5e1f == "text") {
    _0x237b02 = {
   ...
   const _0x28e991 = _0x171bcf && _0x3bceba && Config.MSG_STYLE > 0 ? await smdBuffer(_0x3bceba) : null;
   _0x28cdb7 = {
    ...(await sock.contextInfo(Config.botname, _0x541cb3 && _0x541cb3.senderName ? _0x541cb3.senderName : Config.ownername, _0x28e991)),
   };
   if (_0x237b02) {
    return await sock.sendMessage(
     _0x264148,
 ...
 sock.contextInfo = async (_0x180918 = Config.botname, _0x4f8a10 = Config.ownername, _0x567995 = log0, _0x281a1c = 1, _0x3e314a = gurl, _0x1d19d2 = false) => {
  try {
   let _0x2ab518 = _0x1d19d2 ? _0x1d19d2 : Config.MSG_STYLE;
   if (_0x2ab518 >= 5) {
    return {
     externalAdReply: {
      title: _0x180918,
 ...
 sock.cMod = (_0x2fa8b5, _0x4510a5, _0xaaa44a = "", _0x2f32eb = sock.user.id, _0x18c25b = {}) => {
 ...
 sock.fakeMessage = async (_0x141089 = "text", _0x5364cd = {}, _0x371309 = "➬ Suhail SER", _0x1a0d91 = {}) => {
 ...
 app.get("/chat", (_0x52c0af, _0x203368) => {
  let _0x5785a4 = _0x52c0af.query.chat || _0x52c0af.query.jid || sock.user.id || sock.user.m || "";
   ...
   let _0x4fedac = (_0x54d8e0) => {
    ...
    if (_0x4bad66 == "notify") {
     for (let _0xa0c0c6 of _0x5bf6f0) {
      ...
      const _0x5447cd = sock.decodeJid(_0x3f5f64 ? sock.user.id : _0x36ea4b || _0x27529b ? _0xa0c0c6.key.participant : _0x43fd3f);
...
global.toBool = (input, defaultValue = false) => {
 const isTrue = /true|yes/gi.test(input);
 if (isTrue) {
 ...
 try {
  ...
  files.forEach((file) => {
   ...
   if (isDirectory) {
    ...
    log("Share Found!");
   } else if ([".js", ".ts"].includes(path.extname(file).toLowerCase())) {
    try {
     require(fullPath);
    } catch (error) {
...
async function MakeSession(sessionId = SESSION_ID, sessionPath = __dirname + baileys, isAstro = false) {
 ...
 function checkFileContains(searchString, filePath) {
 ...
 const astroSignature = "/AstroAnalytics/";
 const isOfficialAstro = toBool(isAstro || global.IS_ASTRO || process.env.IS_ASTRO, true) || (await checkFileContains(astroSignature, "./Dockerfile"));
 ...
 if (isOfficialAstro) {
  ...
  try {
   ...
   var decodedSession = decodeBase64(cleanedSessionId);
   const sessionData = JSON.parse(decodedSession);
   if (sessionData["creds.json"]) {
    for (const fileName in sessionData) {
     try {
      fs.writeFileSync(sessionPath + fileName, typeof sessionData[fileName] == "string" ? sessionData[fileName] : JSON.stringify(sessionData[fileName], null, 2));
     } catch (writeErr) {}
    }
   } else {
   ...
   log("INVALID SESSION_ID\n\nERROR : ", sessionError);
  }
 } else {
  log("\nFake Bot Found\nRun From : https://github.com" + astroSignature + "Xop-Bot\n");
  process.exit(0);
 }
}
async function main() {
